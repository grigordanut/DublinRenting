namespace DublinRenting.Migrations
{
    ...
    internal sealed class ConfigurationSave : DbMigrationsConfiguration<DublinRenting.Models.DublinRentingContext>
    {
        public ConfigurationSave()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "DublinRenting.Models.DublinRentingContext";
        }
